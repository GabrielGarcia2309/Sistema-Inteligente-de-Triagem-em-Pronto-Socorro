...
Original file is located at
    https://colab.research.google.com/drive/19Ec16y23eKYriMbhIp7hV5b35QRpdm4Q
...
# Instala a biblioteca necessária (corre isto primeiro na célula)
...
# --- DIAPOSITIVO 1: CAPA ---
slide_layout_capa = prs.slide_layouts[0]
slide_capa = prs.slides.add_slide(slide_layout_capa)
title_capa = slide_capa.shapes.title
subtitle_capa = slide_capa.placeholders[1]
title_capa.text = "Sistema Inteligente de Triagem em Pronto-Socorro"
subtitle_capa.text = "Otimização Heurística e Inferência Bayesiana aplicadas à Saúde Pública\nEquipe: Gabriel Garcia, João Gabriel Aquino, Rômulo Emanuel"

# --- DIAPOSITIVO 2: O PROBLEMA ---
slide_layout_texto = prs.slide_layouts[1]
slide_2 = prs.slides.add_slide(slide_layout_texto)
title_2 = slide_2.shapes.title
body_2 = slide_2.placeholders[1]
title_2.text = "O Paradigma da Triagem (Estático vs. Dinâmico)"
tf_2 = body_2.text_frame
tf_2.text = "Modelo Atual (FIFO):"
p = tf_2.add_paragraph()
p.text = "Ordem de chegada, cego à biologia, estático."
p.level = 1
p2 = tf_2.add_paragraph()
p2.text = "Modelo Proposto:"
p2.level = 0
p3 = tf_2.add_paragraph()
p3.text = "Dinâmico, preditivo, focado na mitigação de risco temporal."
p3.level = 1

# --- DIAPOSITIVO 3: MÓDULO 1 ---
slide_3 = prs.slides.add_slide(slide_layout_texto)
title_3 = slide_3.shapes.title
body_3 = slide_3.placeholders[1]
title_3.text = "Módulo 1 - Modelagem Bayesiana"
tf_3 = body_3.text_frame
tf_3.text = "Fundamentação Clínica e Estatística:"
tf_3.add_paragraph().text = "Base sintética de 1.000 pacientes calibrada pelo Protocolo de Manchester."
tf_3.add_paragraph().text = "6 Variáveis Observáveis (sintomas e sinais vitais)."
tf_3.add_paragraph().text = "Inferência Bayesiana (pgmpy) para extrair o risco clínico (P)."

# --- DIAPOSITIVO 4: MÓDULO 2 ---
slide_4 = prs.slides.add_slide(slide_layout_texto)
title_4 = slide_4.shapes.title
body_4 = slide_4.placeholders[1]
title_4.text = "Módulo 2 - A Inteligência do Algoritmo A*"
tf_4 = body_4.text_frame
tf_4.text = "O tempo como Bomba-Relógio:"
tf_4.add_paragraph().text = "Função de Risco Exponencial para prever a deterioração clínica."
tf_4.add_paragraph().text = "Custo g(n): Dano colateral gerado pela espera na fila."
tf_4.add_paragraph().text = "Heurística Admissível: Soma dos riscos atuais da sala de espera."

# --- DIAPOSITIVO 5: RESULTADOS ---
slide_5 = prs.slides.add_slide(slide_layout_texto)
title_5 = slide_5.shapes.title
body_5 = slide_5.placeholders[1]
title_5.text = "Resultados e o Colapso do FIFO"
tf_5 = body_5.text_frame
tf_5.text = "Cenário de Estresse (25 Pacientes):"
tf_5.add_paragraph().text = "Custo FIFO: 14.646,26 (Risco amplificado exponencialmente)"
tf_5.add_paragraph().text = "Custo Gulosa: 2.854,06 (Mitigação de danos severos)"
tf_5.add_paragraph().text = "Limitação de Hardware: A explosão combinatória do A* exato (25! permutações)."

# Guarda o ficheiro no teu ambiente Colab
prs.save('Apresentacao_Trabalho_IA.pptx')
print("Ficheiro Apresentacao_Trabalho_IA.pptx gerado com sucesso! Verifica a pasta de ficheiros do Colab para descarregar.")

# Instale a biblioteca necessária executando esta célula
!pip install python-pptx
...
subtitle_capa = slide_capa.placeholders[1]
title_capa.text = "Sistema Inteligente de Triagem em Pronto-Socorro"
subtitle_capa.text = "Otimização Heurística e Redes Bayesianas aplicadas à Saúde Pública\nEquipe: João Gabriel Aquino, Gabriel Garcia, Rômulo Emanuel"
...
title_2 = slide_2.shapes.title
body_2 = slide_2.placeholders[1]
title_2.text = "O Problema e a Deterioração Clínica"
tf_2 = body_2.text_frame
tf_2.text = "O Modelo Tradicional: Triagem manual -> Estática -> Cega ao tempo."
tf_2.add_paragraph().text = "O Inimigo Invisível: A Deterioração Clínica na fila de espera."
tf_2.add_paragraph().text = "Nossa Proposta: IA como agente de intervenção ativa, calculando o risco dinâmico acumulado."

# --- SLIDE 3: MÓDULO 1 ---
slide_3 = prs.slides.add_slide(slide_layout_texto)
title_3 = slide_3.shapes.title
body_3 = slide_3.placeholders[1]
title_3.text = "Módulo 1 — Modelagem Bayesiana e Dados"
tf_3 = body_3.text_frame
tf_3.text = "Grafo Direcionado: 6 Nós Observáveis (Febre, O2, PA, FC, Dor, Comorbidades) -> 1 Nó Alvo (Gravidade)."
tf_3.add_paragraph().text = "Geração de Dados (n=1000): Pesos baseados nos discriminadores do Protocolo de Manchester."
tf_3.add_paragraph().text = "Machine Learning: Uso do pgmpy com método .fit() para extração automática das CPTs sem vieses manuais."

# --- SLIDE 4: MÓDULO 2 ---
slide_4 = prs.slides.add_slide(slide_layout_texto)
title_4 = slide_4.shapes.title
body_4 = slide_4.placeholders[1]
title_4.text = "Módulo 2 — O Motor A* e a Matemática do Risco"
tf_4 = body_4.text_frame
tf_4.text = "A Bomba-Relógio: Risco = P(Alta) * e^(t/30.0) (a base de Euler espelha a deterioração biológica)."
tf_4.add_paragraph().text = "Transição de Estado: Ação = Atender 1 paciente (Avança o relógio em 10 minutos)."
tf_4.add_paragraph().text = "Custo da Ação g(n): Dano colateral somado de TODOS que continuam aguardando."
tf_4.add_paragraph().text = "Heurística h(n): Admissível, calculando a soma instantânea dos riscos presentes."

# --- SLIDE 5: INTEGRAÇÃO ---
slide_5 = prs.slides.add_slide(slide_layout_texto)
title_5 = slide_5.shapes.title
body_5 = slide_5.placeholders[1]
title_5.text = "Integração Contínua (O Pipeline)"
tf_5 = body_5.text_frame
tf_5.text = "Fluxo Desacoplado: Ficha de Triagem -> pgmpy -> Tradução -> Motor de Fila."
tf_5.add_paragraph().text = "A Ponte Algorítmica: A função `receber_paciente` consolida a modularidade do software."
tf_5.add_paragraph().text = "Extração da escalar P(Alta) gerada na estatística para instanciar o objeto Paciente no espaço de busca."

# --- SLIDE 6: RESULTADOS SIMPLES ---
slide_6 = prs.slides.add_slide(slide_layout_texto)
title_6 = slide_6.shapes.title
body_6 = slide_6.placeholders[1]
title_6.text = "Experimentos — Cenário Simples (5 Pacientes)"
tf_6 = body_6.text_frame
tf_6.text = "A Falha da Estratégia Gulosa (Miopia Temporal): Custo 7.92."
tf_6.add_paragraph().text = "A Ineficiência da Ordem de Chegada (FIFO): Custo 10.55."
tf_6.add_paragraph().text = "A Otimalidade do Algoritmo A*: Menor custo global (6.90)."
tf_6.add_paragraph().text = "Eficiência Matemática: A rota perfeita foi encontrada visitando apenas 7 nós na árvore de busca."

# --- SLIDE 7: RESULTADOS MÉDIOS ---
slide_7 = prs.slides.add_slide(slide_layout_texto)
title_7 = slide_7.shapes.title
body_7 = slide_7.placeholders[1]
title_7.text = "Experimentos — O Colapso no Cenário Médio"
tf_7 = body_7.text_frame
tf_7.text = "A Barreira do Hardware: A busca exata morre na Explosão Combinatória de 25! permutações (escala de septilhões)."
tf_7.add_paragraph().text = "O Duelo Final em Grande Escala (25 Pacientes):"
tf_7.add_paragraph().text = "-> Custo Gulosa: 2.854,06 (Contenção de danos severos)"
tf_7.add_paragraph().text = "-> Custo FIFO: 14.646,26 (O colapso exponencial do risco por ignorar os dados clínicos)"

# --- SLIDE 8: CONCLUSÃO ---
slide_8 = prs.slides.add_slide(slide_layout_texto)
title_8 = slide_8.shapes.title
body_8 = slide_8.placeholders[1]
title_8.text = "Conclusão"
tf_8 = body_8.text_frame
tf_8.text = "O que funcionou: O pipeline eficaz unindo incerteza clínica a um motor algorítmico logístico."
tf_8.add_paragraph().text = "O que melhorar: Para implantação em hospitais reais, substitui-se a busca exata (A*) por uma Busca Local (Simulated Annealing)."
tf_8.add_paragraph().text = "Impacto Social: Transição de uma IA passiva de 'classificação' para uma logística preditiva e ativa, gerando valor real para proteger a vida."

# Salvar o arquivo
prs.save('Defesa_Trabalho_Final_IA.pptx')
print("✅ Ficheiro 'Defesa_Trabalho_Final_IA.pptx' gerado com sucesso!")
print("-> Verifique a aba de arquivos no menu lateral esquerdo do Colab para fazer o download.")